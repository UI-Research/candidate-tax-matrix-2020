    ...
    return (
        <div>
            ...
            <div className={candidateListStyles.filterButtonContainer + " " + (props.mobileMenuIsOpen ? candidateListStyles.opened : "")}>
                ...
                {props.listName === "candidates" && <p className={candidateListStyles.note}>Asterisks denote candidates who suspended their campaigns after this tool was launched.</p>}
                <button
