            ...
            <div className="contentContainer">
                ...
                {candidateLastName === "Biden" &&
                    <p style={{ fontSize: `14px`,
                                ...
                                fontStyle: `italic`,
                                marginTop: `20px` }}>
                        Note: The estimates of revenue impact and percent change in after-tax income are based on the Tax Policy Center’s <a href={analysisData["Biden"]["Link"]} target="_blank" rel="noopener noreferrer" className={(isPrint ? modalContentStyles.printLink : "")}>analysis</a> of Biden’s proposals as of September 28, 2020. These estimates were corrected on November X, 2020. More details are available here.
                    </p>
                }
            </div>
    }
